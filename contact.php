...
if(isset($_POST['nguoi_nhan']))
{
	...
	$mail->Username   = "kieudao0603@gmail.com";
	$mail->Password   = "ubqwtdzxtyhowmxx";

	//tạo nội dung, tiêu đề và danh sách gửi email
	$mail->isHTML(True);
	$mail->addAddress($nguoi_nhan,"Dao");
	$mail->setFrom("kieudao0603@gmail.com","kieudao");
	$mail->AddCC($CC."");//gửi nhận thấy email người đc gửi cùng
	$mail->Subject=$tieu_de;
	$mail->MsgHTML("Nội dung người nhận:".$noi_dung);
...
<div id="msg"><?php if(isset($msg))
    ...
    <div class="google_map_area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.6607742867327!2d105.78447481488371!3d21.046255085988868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab325c9d85ff%3A0x92f275da77aa7354!2zMjM0IEhvw6BuZyBRdeG7kWMgVmnhu4d0LCBD4buVIE5odeG6vywgVOG7qyBMacOqbSwgSMOgIE7hu5lpLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1666536757972!5m2!1svi!2s" width="100%" height="500px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="company_right_area">
                        ...
                        <div class="contact_addon_content">
                            ...
                            <p><span><i class="fa fa-envelope"></i></span> fcflower-shop.com</p>
                            <p><span><i class="fa fa-phone"></i></span> 0376312334</p>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function initialize() {
            var mapOptions = {
                zoom: 15,
                scrollwheel: false,
                center: new google.maps.LatLng(21.0462551, 105.7844748,17)
            };

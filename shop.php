                        ...
                        <div class="catagory_price_color">
                            ...
                            <div class="priceing_area">
                                ...
                                <div class="info_widget">
                                    <form action="shop.php" method="GET" class="">
                                        <input type="text" class="form-control" placeholder="minprice" name="minprice" required>
                                        <input type="text" class="form-control" placeholder="maxprice" name="maxprice" required>
                                        <input type="submit" class="" value="Lọc">
                                    </form>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="clothing_carousel_list">
                                    <div class="single_clothing_product">
                                        <?php
                                        $rws=query("SELECT * FROM `products` WHERE product_id<8");
                     ...
                     <div class="tab-content tab_content_style">
                        <div id="tab1" class="tab-pane fade in active">
                            <div class="row">
                                ...
                                $rows=query("SELECT * FROM `products` WHERE `product_price`BETWEEN $minprice AND $maxprice");}
                                        ...
                                        <div class="product_list">
                                            <div class="single_product repomsive_768">
                                                ...
                                                <div class="product_details">
                                                    ...
                                                    <p><span class="regular_price">550000 VND</span> <span class="popular_price"><?php echo $price ?>VND</span></p>
                                                </div>
